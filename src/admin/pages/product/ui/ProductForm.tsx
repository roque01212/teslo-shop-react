...
const availableSizes: Size[] = ["S", "M", "L", "XL", "XS", "XXL"];
...
export const ProductForm = ({
  ...
  const handleDrop = (e: React.DragEvent) => {
    ...
    // tranformar el formator de los files a un array
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="flex justify-between items-center">
        <AdminTilte title={title} subtitle={subTitle} />
        <div className="flex justify-end mb-10 gap-4">
          ...
          <Button disabled={isPending}>
            <SaveAll className="w-4 h-4" type="submit" />
            Guardar cambios
          </Button>
        </div>
      </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={cn(
                      ...
                      {
                        "focus:ring-red-500 border-red-500": errors.title,
                      },
                    )}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={cn(
                        `w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200`,
                        {
                          "focus:ring-red-500 border-red-500": errors.price,
                        },
                      )}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={cn(
                        `w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200`,
                        {
                          "focus:ring-red-500 border-red-500": errors.stock,
                        },
                      )}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={cn(
                      `w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200`,
                      {
                        "focus:ring-red-500 border-red-500": errors.slug,
                      },
                    )}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={cn(
                      `w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200`,
                      {
                        "focus:ring-red-500 border-red-500": errors.description,
                      },
                    )}
